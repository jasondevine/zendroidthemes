<?php
/**
 * The template for displaying the dark header - this is for demo purposes only as the header type is actually controlled by a php switch block based on customizer choice, with classes doing all the styling. In here, we remove that switch block and simplify the header as much as we can
 *
...
<html class="no-js" <?php language_attributes();?> >
	...
	<body <?php body_class('dark-header');?>>
...
<!-- This is so that we can evenly space items in the flex parent ( the dummy item is given the same width as it's opposite counterpart, and hidden from view) -->
	...
	<header class="dark-header site-header" role="banner">
