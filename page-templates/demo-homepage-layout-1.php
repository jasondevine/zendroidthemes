<?php
/*
Template Name: Demo content - Homepage Layout 1 - Side-by-Side
 */
...
<div class="main-container">
	<div class="main-grid">
		<?php if (is_page('homepage-layout-1') && class_exists('AjaxLoadMore')) {
	?>
...
$ids = implode(', ', $ids);
	...
	echo do_shortcode('[ajax_load_more theme_repeater="homepage-layout-1.php" post_type="post" post__not_in="' . $ids .'" images_loaded="false"]')
	?>
			</main>
