<?php
/*
Template Name: Demo content - Homepage Layout 3 - List
 */
...
<div class="main-container">
	<div class="main-grid">
		<?php if (is_page('homepage-layout-3') && class_exists('AjaxLoadMore')) {
	?>
...
$ids = implode(', ', $ids);
	...
	echo do_shortcode('[ajax_load_more theme_repeater="homepage-layout-3.php" loading_style="infinite classic"  post_type="post" post__not_in="' . $ids .'" images_loaded="true"]')
	?>
			</main>
